...
const EmployeeForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Une erreur s'est produite lors du traitement du formulaire. Veuillez réessayer.");
    }
  };
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {id ? "Modifier un employé" : "Créer un nouveau employé"} 
          </h3>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            {id ? (
              <div className="text-left">
                * Le changement de mot de passe n'est pas autorisé lors de l'édition
              </div>
            ) : (
              <input
                type="password"
